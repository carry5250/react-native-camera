...
export class Constants {
  ...
  static readonly TACK_PHOTO: string = 'takePictureAsync';
  ...
  static readonly CAMERA_PERMISSION = "ohos.permission.CAMERA";
  static readonly MICROPHONE_PERMISSION = "ohos.permission.MICROPHONE";
